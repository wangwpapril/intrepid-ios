...
- (void)addContent {
    ...
    //ADDRESS
    UILabel *addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 5, 300, 25)];
    ...
    UILabel *contactLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, addressText.frame.origin.y + size.height + 5, 300, 25)];
    ...
    UILabel *hoursLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, contactText.frame.origin.y + contactSize.height + 5, 300, 25)];
    ...
    UILabel *servicesLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, hoursText.frame.origin.y + hoursSize.height + 5, 300, 25)];
    ...
    UILabel *notesLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, servicesText.frame.origin.y + servicesSize.height + 5, 300, 25)];
