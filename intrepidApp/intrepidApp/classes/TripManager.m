...
-(void) populateTrips {
    ...
    [self createEmbassyWithCity:mexicoCity
                      ...
                      withEmail:@"mxico@international.gc.ca"
    ...
    [self createEmbassyWithCity:miami
                      ...
                      withNotes:@"The consulate does not provide regular passport services.\n\nFor general passport enquiries, you may contact Passport Canada either toll free at 1-800-567-6868 (Monday to Friday from 7:30 a.m. to 8 p.m. Eastern Time) or via the General Inquiry Form, available on the website."
